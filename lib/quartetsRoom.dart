...
class _QuartetsRoomState extends State<QuartetsRoom> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.game.getPlayerNeedTurn() is Me && this.widget.game.getPlayerNeedTurn().cards.length == 0) {
      this.widget.game.deck.giveCardToPlayer(this.widget.game.getPlayerNeedTurn());
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ' תור ${widget.game.players[widget.game
                                          .turn].name}',
                                      style: TextStyle(
                                          color: Colors.red,
                                          fontSize: 20,
